...
class Users(Base):
    ...
    id: Mapped[int] = mapped_column(
        Integer,
        Identity(start=91, increment=1, minvalue=1, maxvalue=2147483647, cycle=False, cache=1),
        primary_key=True,
    )
    email: Mapped[str] = mapped_column(String(255))
    hashed_password: Mapped[str] = mapped_column(String(255))
...
class Tasks(Base):
    ...
    id: Mapped[int] = mapped_column(
        Integer,
        Identity(start=542, increment=1, minvalue=1, maxvalue=2147483647, cycle=False, cache=1),
        primary_key=True,
    )
